...
export class TestsComponent implements OnInit {
    ...
    ngOnInit() {
        this.GetAllValues();
        this.tests.created_by = sessionStorage.getItem('email') || ''; 
  ...
  deleteshow:any;
       ...
       Create() {
      this.isVisibleCreate = false;
        this.testsService.PostAlltestsValues(this.tests).subscribe((data:any) => {
            this.tests.name = '',
            this.tests.mail = '',
            this.GetAllValues();
        },
    ...
    Update() {
        this.testsService.Updatetests(this.tests).subscribe((data:any) => {
            this.tests.name = '';
            this.tests.mail = '';
            this.GetAllValues();
            this.isVisibleUpdate = false;
    ...
    Delete(deleteid:any) {
        this.testsService.DeletetestsValues(deleteid).subscribe((data:any) => {
            this.GetAllValues();
        },
        (error:Error) => {
            console.log('Error', error);
    ...
    GetAllValues() {
        this.testsService.GetAlltestsValues().subscribe((data: any) => {
